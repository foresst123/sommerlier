...
STEPS = ("music_analysis", "music_removal",
         ...
         "refinement", "speaker_relabel", "conversation_exports", "export")
...
def test_an_opt_in_step_is_off_unless_it_was_asked_for():
    ...
    assert not steps.opt_in_step_enabled(_args(), "conversation_exports")
    assert not steps.opt_in_step_enabled(_args(step_conversation_exports=None), "conversation_exports")
    assert not steps.opt_in_step_enabled(_args(step_conversation_exports=False), "conversation_exports")
    assert steps.opt_in_step_enabled(_args(step_conversation_exports=True), "conversation_exports")
...
def test_the_ordinary_rule_would_switch_the_same_step_on():
    ...
    assert PipelineService.step_enabled(_args(), "conversation_exports")
